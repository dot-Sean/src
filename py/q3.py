...
for c in str:
  if c in string.ascii_letters:
    ...
    try:
      if \
       stack[-1] in string.ascii_lowercase and \
       stack[-2] in string.ascii_uppercase and \
       stack[-3] in string.ascii_uppercase and \
       stack[-4] in string.ascii_uppercase and \
       stack[-5] in string.ascii_lowercase and \
       stack[-6] in string.ascii_uppercase and \
       stack[-7] in string.ascii_uppercase and \
       stack[-8] in string.ascii_uppercase and \
       stack[-9] in string.ascii_lowercase:
        print stack[-5]
    except:
      pass
